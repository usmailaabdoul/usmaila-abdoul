              ...
              return (
                <li key={experience.company}>
                  <div className="relative flex flex-col gap-5">
                    <time className="absolute top-[6px] right-[calc(100%_+_30px)] -translate-x-[1px] flex gap-5 items-center w-max" dateTime={experience.startDate}>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm font-medium text-foreground-3">{experience.location}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <h3 className="text-xl text-foreground-3">{experience.title}</h3>
                    </div>
                    <div className="mt-1">
                      <ul 
