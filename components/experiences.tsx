                ...
                <li key={experience.company}>
                  <div className="relative flex flex-col gap-5">
                    ...
                    <div className="flex md:flex-row flex-col gap-1 justify-between md:items-center">
                      ...
                      <span className="md:text-sm text-xs font-medium text-foreground-3 font-inter">{experience.location}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <h3 className="md:text-xl text-lg text-foreground-3 font-inter">{experience.title}</h3>
                    </div>
                    <div className="mt-1">
                      <ul 
                        className="list-disc list-inside flex flex-col gap-2 text-foreground-3/90 font-inter" 
